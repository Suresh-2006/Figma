...
<div style="width: 360px; height: 640px; position: relative; background: #07F0FF">
  ...
  <img style="width: 231px; height: 54px; left: 56px; top: 254px; position: absolute" src="https://via.placeholder.com/231x54" />
...
<div style="width: 360px; height: 640px; position: relative; background: white; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border: 1px black solid">
  <img style="width: 300px; height: 45.12px; left: 41px; top: 23px; position: absolute; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25)" src="https://via.placeholder.com/300x45" />
  <img style="width: 360px; height: 640px; left: 0px; top: 0px; position: absolute" src="https://via.placeholder.com/360x640" />
  <img style="width: 300px; height: 45.12px; left: 30px; top: 30px; position: absolute; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25)" src="https://via.placeholder.com/300x45" />
